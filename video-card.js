...
$(document).ready(function(){
                 ...
                 $("#video-player").attr("src","https://player.vimeo.com/video/"+videoPlaySectionData[id-1].vimeoId);
                 $("#view-count").html(videoPlaySectionData[id-1].views);
               ...
               var thumbnail = $("<img>");
               thumbnail.attr("src",playlistData[i].thumbnail);
               thumbnail.attr("class","thumbnail")
               var playlistCard = $("<div>").attr("id",playlistData[i].id);
               playlistCard.attr("class","playlist-card");
               playlistCard.append(thumbnail);
               playlistCard.append(title);
               $("#playlist-wrapper").append(playlistCard);
  };
              $("#1").addClass("active-card");  
